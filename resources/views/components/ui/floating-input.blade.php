...
<div class="relative">
    ...
    <input 
        ...
        {{ $attributes->merge([
            'class' => 'peer w-full px-4 py-3.5 bg-gray-50 dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:border-amber-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none transition-all placeholder-transparent disabled:opacity-50 disabled:cursor-not-allowed' . ($icon ? ' pl-10' : '')
        ]) }}
    >
    <label 
        for="{{ $name }}" 
