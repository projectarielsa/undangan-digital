...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('customer.invitations.create') }}" class="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-amber-600 to-amber-700 text-white text-sm font-semibold rounded-xl shadow-lg shadow-amber-500/25 transition-all">
...
<div class="bg-white dark:bg-gray-800 rounded-2xl border p-16 text-center">
    ...
    <a href="{{ route('customer.invitations.create') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-amber-600 text-white font-medium rounded-xl hover:bg-amber-700 transition">Buat Undangan Pertama</a>
</div>
@else
