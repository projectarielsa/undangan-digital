...
<div class="max-w-4xl">
    <div class="flex items-center justify-between mb-6">
        <a href="{{ route('customer.invitations.index') }}" class="text-sm text-gray-500 hover:text-blue-600 flex items-center gap-1"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>Kembali</a>
    ...
    <form method="POST" action="{{ route('customer.invitations.update', $invitation) }}" enctype="multipart/form-data" class="space-y-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div><label class="block text-sm text-gray-600 mb-1">Music (MP3)</label><input type="file" name="music_file" accept=".mp3,.wav" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-blue-50 file:text-blue-700">@if($invitation->music_url)<p class="text-xs text-green-600 mt-1">Musik saat ini: tersimpan</p>@endif</div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border p-6" x-data="bankAccountsManager()">
            <div class="flex items-center justify-between mb-2">
                ...
                <button type="button" @click="addAccount()" class="px-4 py-2 bg-blue-50 text-blue-700 text-sm font-medium rounded-xl hover:bg-blue-100 transition flex items-center gap-1">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="file" name="qris_image" accept="image/*" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-blue-50 file:text-blue-700">
        ...
        <button type="submit" class="px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-xl shadow-lg shadow-blue-500/25 transition-all hover:shadow-xl">Simpan Perubahan</button>
    </form>
    ...
    <div class="mt-8 bg-white dark:bg-gray-800 rounded-2xl border p-6">
        ...
        <form method="POST" action="{{ route('customer.gallery.store', $invitation) }}" enctype="multipart/form-data" class="mb-6">
            @csrf
            <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-6 text-center hover:border-blue-400 transition">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border p-6">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <a href="{{ route('customer.invitations.love-story', $invitation) }}" class="inline-block mt-3 text-sm text-blue-600 hover:text-blue-700 font-medium">Edit Love Story &rarr;</a>
                    @else
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border p-6">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <a href="{{ route('customer.invitations.analytics', $invitation) }}" class="inline-block mt-3 text-sm text-blue-600 hover:text-blue-700 font-medium">Lihat Analytics &rarr;</a>
                    @else
                    <p class="mt-3 text-xs text-gray-400">Premium & Exclusive</p>
                    @endif
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border p-6">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <a href="{{ route('customer.invitations.qr-checkin', $invitation) }}" class="inline-block mt-3 text-sm text-blue-600 hover:text-blue-700 font-medium">Kelola QR Check-in &rarr;</a>
                    @else
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border p-6">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <a href="{{ route('customer.invitations.custom-domain', $invitation) }}" class="inline-block mt-3 text-sm text-blue-600 hover:text-blue-700 font-medium">Setting Domain &rarr;</a>
                    @else
                    <p class="mt-3 text-xs text-gray-400">Exclusive only</p>
                    @endif
                </div>
