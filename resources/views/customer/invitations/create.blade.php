...
<div class="max-w-5xl" x-data="invitationWizard()">
    <!-- Back Button -->
    <div class="mb-6">
        <a href="{{ route('customer.invitations.index') }}" class="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-amber-600 transition-colors group">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between relative">
            ...
            <div class="absolute top-5 left-0 h-0.5 bg-gradient-to-r from-amber-500 to-rose-500 mx-12 transition-all duration-500" :style="`width: calc(${(currentStep - 1) / 4 * 100}% - 6rem)`"></div>
            ...
            <template x-for="(step, index) in steps" :key="index">
                <div class="relative z-10 flex flex-col items-center">
                    <button @click="goToStep(index + 1)" 
                            ...
                            :class="{
                                'bg-gradient-to-r from-amber-500 to-rose-500 text-white shadow-lg shadow-amber-500/30': currentStep === index + 1,
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        ...
                        <label class="cursor-pointer group">
                            <input type="radio" name="template_id" value="{{ $template->id }}" class="peer hidden" {{ $loop->first ? 'checked' : '' }} x-model="formData.template_id">
                            <div class="relative rounded-2xl border-2 border-gray-200 dark:border-gray-600 peer-checked:border-amber-500 peer-checked:ring-4 peer-checked:ring-amber-500/20 overflow-hidden transition-all duration-300 group-hover:border-amber-300 group-hover:shadow-lg">
                                <!-- Preview -->
                                <div class="aspect-[3/4] flex items-center justify-center relative" style="background: linear-gradient(135deg, {{ $template->color_primary }}25, {{ $template->color_secondary }}15)">
                                    ...
                                    <div class="absolute top-2 right-2">
                                        <span class="px-2 py-0.5 bg-amber-500 text-white text-[10px] font-bold rounded-full flex items-center gap-1">
                                    ...
                                    @endif
                                    <!-- Check Mark -->
                                    <div class="absolute inset-0 bg-amber-500/20 flex items-center justify-center opacity-0 peer-checked:opacity-100 transition-opacity">
                                ...
                                <div class="p-3 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <div class="flex items-center gap-1 mt-1">
                                        <div class="w-3 h-3 rounded-full border border-white shadow-sm" style="background: {{ $template->color_primary }}"></div>
                                        <div class="w-3 h-3 rounded-full border border-white shadow-sm" style="background: {{ $template->color_secondary }}"></div>
                                    </div>
                                </div>
                            </div>
                        </label>
                        ...
                        <div class="space-y-5">
                            ...
                            <div class="relative">
                                <input type="text" name="groom_name" id="groom_name" value="{{ old('groom_name') }}" required
                                       class="peer w-full px-4 py-3.5 bg-gray-50 dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:border-amber-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none transition-all placeholder-transparent"
                            ...
                            <div class="relative">
                                <input type="text" name="groom_instagram" id="groom_instagram" value="{{ old('groom_instagram') }}"
                                       class="peer w-full px-4 py-3.5 pl-10 bg-gray-50 dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:border-amber-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none transition-all placeholder-transparent"
                            ...
                            <div>
                                ...
                                <div class="relative" x-data="{ groomPreview: null }">
                                    ...
                                    <label for="groom_photo" class="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl cursor-pointer hover:border-amber-400 hover:bg-amber-50/50 dark:hover:bg-amber-900/10 transition-all">
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <div class="relative" x-data="{ bridePreview: null }">
                                    ...
                                    <label for="bride_photo" class="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl cursor-pointer hover:border-amber-400 hover:bg-amber-50/50 dark:hover:bg-amber-900/10 transition-all">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid md:grid-cols-3 gap-4">
                        <div class="relative">
                            <input type="date" name="event_date" id="event_date" value="{{ old('event_date') }}" required
                                   class="peer w-full px-4 py-3.5 bg-gray-50 dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:border-amber-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none transition-all">
                    ...
                    <div class="relative">
                        <textarea name="event_address" id="event_address" rows="3"
                                  class="peer w-full px-4 py-3.5 bg-gray-50 dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:border-amber-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none transition-all resize-none placeholder-transparent"
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative" x-data="{ coverPreview: null }">
                            ...
                            <label for="cover_image" class="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl cursor-pointer hover:border-amber-400 hover:bg-amber-50/50 dark:hover:bg-amber-900/10 transition-all">
                    ...
                    <div class="p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="text-sm">
                                <p class="font-medium text-amber-800 dark:text-amber-200">Tips</p>
                                <p class="text-amber-700 dark:text-amber-300 mt-1">Anda dapat menambahkan galeri foto, musik, dan informasi amplop digital setelah undangan dibuat melalui halaman edit.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-6 mb-8">
                        <!-- Couple Summary -->
                        <div class="p-5 bg-gradient-to-br from-rose-50 to-amber-50 dark:from-rose-900/20 dark:to-amber-900/20 rounded-2xl border border-rose-100 dark:border-rose-800">
        ...
        <div class="flex items-center justify-between mt-8 pt-6 border-t border-gray-100 dark:border-gray-700">
            ...
            <div class="flex items-center gap-3">
                ...
                <button type="button" 
                        ...
                        class="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-500 to-amber-600 text-white font-semibold rounded-xl hover:from-amber-600 hover:to-amber-700 transition-all shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40">
                    Selanjutnya
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
