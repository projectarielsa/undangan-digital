...
<div class="max-w-2xl mx-auto" x-data="qrScanner()">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('customer.invitations.qr-checkin.welcome-display', $invitation) }}" target="_blank" class="text-sm text-amber-600 hover:text-amber-700 flex items-center gap-1 font-medium">
