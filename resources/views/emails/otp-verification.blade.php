...
<head>
    ...
    <style>
        ...
        .code-box { background: #fffbeb; border: 2px solid #3B82F6; border-radius: 12px; padding: 24px; text-align: center; margin: 24px 0; }
...
<body>
    <div class="card">
        <div class="header">
            <h1 style="color: #3B82F6; margin: 0; font-size: 24px;">Ellori</h1>
        </div>
        ...
        <div class="footer">
            <p>&copy; {{ date('Y') }} Ellori. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
