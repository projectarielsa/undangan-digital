    ...
    >
        <template x-if="!preview">
            <div class="text-center">
                <div class="w-14 h-14 mx-auto mb-4 bg-gray-100 dark:bg-gray-700 rounded-2xl flex items-center justify-center" :class="dragover && 'bg-blue-100 dark:bg-blue-900/30'">
                    <svg class="w-7 h-7 text-gray-400" :class="dragover && 'text-blue-500'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                    </svg>
                </div>
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">
                    <span class="font-medium text-blue-600 dark:text-blue-400">Klik untuk upload</span> atau drag & drop
                </p>
