...
<div class="min-h-screen bg-gray-50 py-16 px-6">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-16">
            ...
            <a href="{{ route('home') }}" class="inline-flex items-center gap-2 mt-6 text-blue-600 hover:text-blue-700 font-medium">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <a href="{{ route('demo.show', $template->slug) }}" class="group block bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-200">
                <!-- Preview -->
                <div class="aspect-[3/4] relative overflow-hidden" style="background: linear-gradient(135deg, {{ $template->color_primary }}20, {{ $template->color_secondary }}10)">
                    ...
                    <div class="absolute top-4 right-4">
                        <span class="px-3 py-1 bg-blue-500 text-white text-xs font-bold rounded-full flex items-center gap-1">
        ...
        <div class="text-center mt-16">
            ...
            <a href="{{ route('register') }}" class="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all shadow-lg shadow-blue-500/25">
                Mulai Buat Undangan
