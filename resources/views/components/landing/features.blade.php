...
<section id="features" class="py-24 lg:py-32 bg-white dark:bg-gray-900 relative overflow-hidden">
    ...
    <div class="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-amber-50/50 to-transparent dark:from-amber-900/10 dark:to-transparent"></div>
    <div class="absolute bottom-0 left-0 w-96 h-96 bg-rose-100/50 dark:bg-rose-900/10 rounded-full blur-3xl -translate-x-1/2 translate-y-1/2"></div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto mb-20">
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-amber-100 dark:bg-amber-900/30 rounded-full mb-6">
                ...
                <span class="text-sm font-semibold text-amber-700 dark:text-amber-300">Fitur Premium</span>
            </div>
            <h2 class="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                Semua yang Anda Butuhkan untuk
                <span class="bg-gradient-to-r from-amber-500 to-rose-500 bg-clip-text text-transparent">Hari Spesial</span>
            </h2>
