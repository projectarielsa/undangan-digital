                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        ...
                        <label class="{{ $isLocked ? 'cursor-not-allowed' : 'cursor-pointer' }} group">
                            ...
                            <div class="relative rounded-2xl border-2 border-gray-200 dark:border-gray-600 peer-checked:border-amber-500 peer-checked:ring-4 peer-checked:ring-amber-500/20 overflow-hidden transition-all duration-300 {{ $isLocked ? 'opacity-60' : 'group-hover:border-amber-300 group-hover:shadow-lg' }}">
                                <!-- Preview -->
                                <div class="aspect-[3/4] flex items-center justify-center relative" style="background: linear-gradient(135deg, {{ $template->color_primary }}25, {{ $template->color_secondary }}15)">
                                    ...
                                    <div class="absolute top-2 right-2">
                                        <span class="px-2 py-0.5 {{ $isLocked ? 'bg-gray-500' : 'bg-amber-500' }} text-white text-[10px] font-bold rounded-full flex items-center gap-1">
                                            @if($isLocked)
