...
<div>
    ...
    <p class="text-gray-500 dark:text-gray-400 mb-8">Mulai buat undangan digital impian Anda</p>
    ...
    <a href="{{ route('register.google') }}" class="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-200 dark:border-gray-700 rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-all">
