    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-amber-900 via-amber-800 to-yellow-900">
        ...
        <div class="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
            <div class="max-w-md text-center">
                ...
                <h1 class="text-4xl font-bold font-serif mb-4">Undangan Digital Premium</h1>
                <p class="text-amber-100/80 text-lg leading-relaxed">Buat undangan pernikahan digital yang elegan, modern, dan berkesan untuk hari spesial Anda.</p>
                <div class="mt-12 space-y-4">
                    <div class="flex items-center gap-3 text-amber-100/70">
                        <svg class="w-5 h-5 text-amber-300 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z"/></svg>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
        <div class="w-full max-w-md">
            <div class="lg:hidden text-center mb-8">
                <h1 class="text-2xl font-bold font-serif text-amber-900 dark:text-amber-300">Undangan Digital Premium</h1>
            </div>
            @yield('content')
        </div>
    </div>
