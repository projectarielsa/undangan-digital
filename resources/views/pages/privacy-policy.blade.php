        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-6 text-sm">
                    <a href="{{ route('privacy') }}" class="text-blue-600 dark:text-blue-400 font-medium">Kebijakan Privasi</a>
                    <a href="{{ route('terms') }}" class="text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Syarat & Ketentuan</a>
                </div>
            </div>
        </div>
    </footer>
