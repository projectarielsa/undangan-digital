...
<section id="templates" class="py-24 lg:py-32 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="relative bg-white dark:bg-gray-800 rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 dark:border-gray-700 group-hover:border-transparent group-hover:-translate-y-2">
                    ...
                    <div class="relative aspect-[3/4] overflow-hidden">
                        ...
                        <div class="absolute top-4 right-4">
                            <div class="px-3 py-1.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-xs font-bold rounded-full shadow-lg flex items-center gap-1">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-gray-900/80 via-gray-900/40 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-end justify-center pb-8">
                            <a href="{{ route('demo.show', $template->slug) }}" class="px-6 py-3 bg-white text-gray-900 font-semibold rounded-full transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 hover:bg-blue-500 hover:text-white">
                                Lihat Demo
                            </a>
                        </div>
                    </div>
        ...
        <div class="mt-16 text-center">
            <a href="{{ route('demo.index') }}" class="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-sky-500 to-blue-500 text-white font-semibold rounded-full shadow-lg shadow-sky-500/25 hover:shadow-sky-500/40 transition-all hover:scale-105">
