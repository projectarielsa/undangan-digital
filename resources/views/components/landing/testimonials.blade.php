...
<section id="testimonials" class="py-24 lg:py-32 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 relative overflow-hidden">
    ...
    <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-gradient-to-r from-amber-100/30 to-rose-100/30 dark:from-amber-900/10 dark:to-rose-900/10 rounded-full blur-3xl"></div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto mb-16">
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-rose-100 to-amber-100 dark:from-rose-900/30 dark:to-amber-900/30 rounded-full mb-6">
                ...
                <span class="text-sm font-semibold text-rose-700 dark:text-rose-300">4.9/5 Rating</span>
            </div>
            <h2 class="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                Apa Kata <span class="bg-gradient-to-r from-rose-500 to-amber-500 bg-clip-text text-transparent">Mereka?</span>
            </h2>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div class="group relative bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 hover:-translate-y-1">
                ...
                <div class="absolute -top-4 left-8">
                    <div class="w-8 h-8 bg-gradient-to-r from-amber-500 to-rose-500 rounded-full flex items-center justify-center shadow-lg">
                ...
                <div class="flex items-center gap-4">
                    <div class="w-12 h-12 rounded-full bg-gradient-to-br from-amber-200 to-rose-200 dark:from-amber-800 dark:to-rose-800 flex items-center justify-center">
                        <span class="text-amber-700 dark:text-amber-200 font-semibold">{{ strtoupper(substr($testimonial->name ?? 'U', 0, 1)) }}</span>
                    </div>
                    <div>
            ...
            <div class="group relative bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 hover:-translate-y-1">
                ...
                <div class="flex items-center gap-4">
                    <div class="w-12 h-12 rounded-full bg-gradient-to-br from-amber-200 to-rose-200 dark:from-amber-800 dark:to-rose-800 flex items-center justify-center">
                        <span class="text-amber-700 dark:text-amber-200 font-semibold">{{ ['A', 'B', 'R'][$i] }}</span>
                    </div>
                    <div>
