...
<div class="max-w-2xl mx-auto" x-data="qrScanner()">
    <div class="flex items-center justify-between mb-6">
        <a href="{{ route('customer.invitations.qr-checkin', $invitation) }}" class="text-sm text-gray-500 hover:text-blue-600 flex items-center gap-1">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
            Kembali
        </a>
        <a href="{{ route('customer.invitations.qr-checkin.welcome-display', $invitation) }}" target="_blank" class="text-sm text-blue-600 hover:text-blue-700 flex items-center gap-1 font-medium">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
            Buka Welcome Display
        </a>
    </div>
    ...
    <div class="grid grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border p-4 text-center">
            <p class="text-2xl font-bold text-blue-600" id="stat-remaining">{{ $stats['total_guests'] - $stats['checked_in'] }}</p>
